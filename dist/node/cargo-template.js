;(function(root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['Handlebars', 'superagent', 'underscore'], factory);
    } else if (typeof exports === 'object') {
        module.exports = factory(require('Handlebars'), require('superagent'), require('underscore'));
    } else {
        root.cargo = root.cargo || {};
        root.cargo.Template = factory(root.Handlebars, root.superagent, root.underscore);
    }
}(this, function(Handlebars, superagent, _) {
