...
var Component = function (options) {
    ...
    this.withTemplate = function (templateFn) {
        ...
        if (!templateFn) {
            ...
            t.translate = templateFn.translate;
 ...
 * @returns {Promise}
 */
Component.template = function (templateURL, translation) {

    var _translate = function (translation, input) {
    ...
    return new Promise(function (resolve, reject) {
        superagent.get(templateURL).end(function (err, response) {
            ...
            var template;
            var translateFn = function(input) { return input; };
            try {
                ...
                if (translation) {
                    translateFn = _translate.bind(undefined, _handlebars, translation);
                    _handlebars.registerHelper('i18n', translateFn);
                    translateFn.translation = translation;
                }
            } catch (e) {
            ...
            innerFns.translate = translateFn;
